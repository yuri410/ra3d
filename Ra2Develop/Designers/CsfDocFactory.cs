...
{
    public class CsfDocFactory : DocumentAbstractFactory
    {
        public override DocumentBase CreateInstance(ResourceLocation res)
        {
            return new CsfDocument(this, res);
        }
        ...
        {
            get { return new string[] { CsfDocument.Extension }; }
        }
