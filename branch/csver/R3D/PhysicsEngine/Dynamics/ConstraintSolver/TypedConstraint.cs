...
namespace R3D.PhysicsEngine.Dynamics
{
	...
	public abstract class TypedConstraint
	{
        ...
        public virtual RigidBody RigidBodyA
        {
            get { return _rbA; }
            protected set { _rbA = value; }
        }
        public virtual RigidBody RigidBodyB
        {
            get { return _rbB; }
            protected set { _rbB = value; }
        }

        public float AppliedImpulse
        {
            get { return _appliedImpulse; }
            protected set { _appliedImpulse = value; }
        }
        public int UserConstraintId
        {
            get { return _userConstraintId; }
            set { _userConstraintId = value; }
        }
        public int UserConstraintType
        {
            get { return _userConstraintType; }
            set { _userConstraintType = value; }
        }
