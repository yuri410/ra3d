...
namespace R3D.PhysicsEngine
{
	...
	public class OptimizedBvh
	{
		...
		private FastList<OptimizedBvhNode> _leafNodes = new FastList<OptimizedBvhNode>();
		...
		public OptimizedBvhNode BuildTree(FastList<OptimizedBvhNode> leafNodes, int startIndex, int endIndex)
		{
		...
		public int CalculateSplittingAxis(FastList<OptimizedBvhNode> leafNodes, int startIndex, int endIndex)
		{
		...
		public int SortAndCalculateSplittingIndex(FastList<OptimizedBvhNode> leafNodes, int startIndex, int endIndex, int splitAxis)
		{
	...
	{
		private FastList<OptimizedBvhNode> _triangleNodes;

		public NodeTriangleCallback(FastList<OptimizedBvhNode> triangleNodes)
		{
			_triangleNodes = triangleNodes;
		}

		public FastList<OptimizedBvhNode> TriangleNodes { get { return _triangleNodes; } set { _triangleNodes = value; } }
