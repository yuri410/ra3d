...
namespace R3D.PhysicsEngine
{
	...
	{
		private FastList<IndexedMesh> _indexedMeshes = new FastList<IndexedMesh>();
		...
		public FastList<IndexedMesh> IndexedMeshes { get { return _indexedMeshes; } }
		...
		public override void GetLockedVertexIndexBase(out FastList<Vector3> verts, out FastList<int> indicies, out int numfaces, int subpart)
		{
			verts = new FastList<Vector3>(_indexedMeshes[subpart].VertexBase);
			indicies = new FastList<int>(_indexedMeshes[subpart].TriangleIndexBase);
			numfaces = _indexedMeshes[subpart].TriangleCount;
		}

		public override void GetLockedReadOnlyVertexIndexBase(out FastList<Vector3> verts, out FastList<int> indicies, out int numfaces, int subpart)
		{
