...
namespace R3D.PhysicsEngine
{
	...
	public class SimulationIslandManager
	{
		...
		public void BuildAndProcessIslands(IDispatcher dispatcher, FastList<CollisionObject> collisionObjects, IIslandCallback callback)
		{
			...
			FastList<PersistentManifold> islandmanifold = new FastList<PersistentManifold>(dispatcher.ManifoldCount);
			...
			FastList<CollisionObject> islandBodies = new FastList<CollisionObject>();
			...
			for (startIslandIndex = 0; startIslandIndex < numElem; startIslandIndex = endIslandIndex)
			{
				...
				FastList<PersistentManifold> startManifold = new FastList<PersistentManifold>(numIslandManifolds);
		...
		{
			void ProcessIsland(FastList<CollisionObject> bodies, FastList<PersistentManifold> manifolds, int numManifolds, int islandID);
		}
	}
}
