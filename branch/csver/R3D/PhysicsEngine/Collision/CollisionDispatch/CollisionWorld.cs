...
namespace R3D.PhysicsEngine
{
	...
	{
		private FastList<CollisionObject> _collisionObjects = new FastList<CollisionObject>();
        ...
        public FastList<CollisionObject> CollisionObjects
        {
		...
		public void RayTest(Vector3 rayFromWorld, Vector3 rayToWorld, RayResultCallback resultCallback, short collisionFilterMask)
		{
            ...
            {
                CollisionObject collisionObject = _collisionObjects[i];
		...
		public class ClosestRayResultCallback : RayResultCallback
		{
			...
			public override float AddSingleResult(LocalRayResult rayResult, bool normalInWorldSpace)
			{
				...
				BulletDebug.Assert(rayResult.HitFraction <= ClosestHitFraction);
