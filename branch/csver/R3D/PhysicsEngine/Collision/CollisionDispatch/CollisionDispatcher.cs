...
namespace R3D.PhysicsEngine
{
	...
	{
		private FastList<PersistentManifold> _manifolds = new FastList<PersistentManifold>();
        ...
        {
            get { return _manifolds.Count; }
        }
        public FastList<PersistentManifold> Manifolds
        {
            get { return _manifolds; }
        }

        public static int GlobalManifoldCount
        {
            get { return _manifoldCount; }
            set { _manifoldCount = value; }
        }
		...
		public virtual bool NeedsCollision(CollisionObject bodyA, CollisionObject bodyB)
		{
			...
			else if (!bodyA.CheckCollideWith(bodyB))
				needsCollision = false;
