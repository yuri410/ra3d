...
{
    [Serializable()]
    public class ModelDocumentConfigs : DocumentConfigBase
    {
        static readonly string ConfigFile = Path.Combine("Configs", "meshdc.xml");


        static ModelDocumentConfigs singleton;

        public static ModelDocumentConfigs Instance
        {
            get
            {
                if (singleton == null)
        ...
        static void Initialize()
        {
            ...
            {
                singleton = Serialization.XmlDeserialize<ModelDocumentConfigs>(ConfigFile);
            }
            else
            {
                singleton = new ModelDocumentConfigs();
            }
        }
        ...
        {
            Serialization.XmlSerialize<ModelDocumentConfigs>(this, ConfigFile);
