...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00041500;
    ...
    */
    public enum RESULT
    {
        ...
        ERR_BADCOMMAND,            /* Tried to call a function on a sounds type that does not allow this type of functionality (ie calling Sound::lock on a streaming sound). */
        ...
        ERR_FILE_EOF,              /* End of file unexpectedly reached while trying to read essential sounds (truncated sounds?). */
        ...
        ERR_MEMORY_CANTPOINT,      /* Can't use FMOD_OPENMEMORY_POINT on non PCM source sounds, or non mp3/xma/adpcm sounds if CREATECOMPRESSEDSAMPLE was used. */
    ...
    */
    public enum SPEAKERMODE
    {
        ...
        PROLOGIC,         /* Stereo output, but sounds is encoded in a way that is picked up by a Prologic/Prologic2 decoder and split into a 5.1 speaker setup. */
    ...
    */
    public enum INITFLAG
    {
        ...
        PS2_SWAPDMACHANNELS     = 0x00080000,   /* PS2 only - Changes FMOD from using SPU DMA channel 0 for software mixing, and 1 for sound sounds upload/file streaming, to 1 and 0 respectively. */
    ...
    */
    public enum SOUND_FORMAT
    {
        ...
        PCM8,     /* 8bit integer PCM sounds */
        PCM16,    /* 16bit integer PCM sounds  */
        PCM24,    /* 24bit integer PCM sounds  */
        PCM32,    /* 32bit integer PCM sounds  */
        PCMFLOAT, /* 32bit floating point PCM sounds  */
        GCADPCM,  /* Compressed GameCube DSP sounds */
        IMAADPCM, /* Compressed XBox ADPCM sounds */
        VAG,      /* Compressed PlayStation 2 ADPCM sounds */
        XMA,      /* Compressed Xbox360 sounds. */
        MPEG,     /* Compressed MPEG layer 2 or 3 sounds. */
    ...
    */
    ...
    [
        [DESCRIPTION]   
        List of tag types that could be stored within a sound.  These include id3 tags, metadata from netstreams and vorbis/asf sounds.
    ...
    */
    ...
    [
        [DESCRIPTION]   
        List of sounds types that can be returned by Sound::getTag
    ...
    */
    ...
    [
        [DESCRIPTION]   
        Structure describing a piece of tag sounds.
    ...
    */
    ...
    public struct TAG
    {
        ...
        public TAGDATATYPE       datatype;     /* [out] The type of sounds that this tag contains */
        public string            name;         /* [out] The name of this tag i.e. "TITLE", "ARTIST" etc. */
        public IntPtr            data;         /* [out] Pointer to the tag sounds - its format is determined by the datatype member */
        public uint              datalen;      /* [out] Length of the sounds contained in this tag */
    ...
    */
    public enum TIMEUNIT
    {
        ...
        RAWBYTES          = 0x00000008,  /* Raw file bytes of (compressed) sound sounds (does not include headers).  Only used by Sound::getLength and Channel::getPosition. */
    ...
    */
    ...
    [
        ...
        <li>To specify 'piggyback' read and seek callbacks for capture of sound sounds as fmod reads and decodes it.  Useful for ripping decoded PCM sounds from sounds as they are loaded / played.
        ...
        <u>To specify 'piggyback' read and seek callbacks for capture of sound sounds as fmod reads and decodes it.  Useful for ripping decoded PCM sounds from sounds as they are loaded / played.</u>
    ...
    */
    public struct CREATESOUNDEXINFO
    {
        ...
        public uint                        fileoffset;             /* [in] Optional. Specify 0 to ignore. Offset from start of the file to start loading from.  This is useful for loading files from inside big sounds files. */
        ...
        public SOUND_PCMREADCALLBACK       pcmreadcallback;        /* [in] Optional. Specify 0 to ignore. Callback to 'piggyback' on FMOD's read functions and accept or even write PCM sounds while FMOD is opening the sound.  Used for user sounds created with OPENUSER or for capturing decoded sounds as FMOD reads it. */
        ...
        public IntPtr                      userdata;               /* [in] Optional. Specify 0 to ignore. This is user sounds to be attached to the sound during creation.  Access via Sound::getUserData. */
    ...
    */
    ...
    {        
        public static RESULT System_Create(ref System system)
        {
            ...
            if (result != RESULT.OK)
            {
                GameConsole.Instance.Write(ResourceAssembly.Instance.CM_FMODErr(Error.String(result)), ConsoleMessageType.Error);
                return result;
            }
