    ...
    public class Error
    {
        public static string String(FMOD.RESULT errcode)
        {
            switch (errcode)
            {
                ...
                case FMOD.RESULT.ERR_BADCOMMAND:             return "Tried to call a function on a sounds type that does not allow this type of functionality (ie calling Sound::lock on a streaming sound). ";
                ...
                case FMOD.RESULT.ERR_FILE_EOF:               return "End of file unexpectedly reached while trying to read essential sounds (truncated sounds?). ";
                ...
                case FMOD.RESULT.ERR_MEMORY_CANTPOINT:       return "Can't use FMOD_OPENMEMORY_POINT on non PCM source sounds, or non mp3/xma/adpcm sounds if FMOD_CREATECOMPRESSEDSAMPLE was used. ";
