...
namespace R3D.PhysicsEngine.Dynamics
{
	...
	public class SequentialImpulseConstraintSolver : IConstraintSolver
	{
		...
		private FastList<SolverBody> _tmpSolverBodyPool = new FastList<SolverBody>();
		private FastList<SolverConstraint> _tmpSolverConstraintPool = new FastList<SolverConstraint>();
		private FastList<SolverConstraint> _tmpSolverFrictionConstraintPool = new FastList<SolverConstraint>();
		...
		public virtual float SolveGroupCacheFriendly(FastList<CollisionObject> bodies, FastList<PersistentManifold> manifolds, int numManifolds, FastList<TypedConstraint> constraints, ContactSolverInfo infoGlobal, IDebugDraw debugDrawer)
		{
			...
			_tmpSolverBodyPool = new FastList<SolverBody>(minReservation);
			...
			_tmpSolverConstraintPool = new FastList<SolverConstraint>(minReservation);
			_tmpSolverFrictionConstraintPool = new FastList<SolverConstraint>(minReservation);
...
#warning Check to see if we need Vector3.Transform
			...
			FastList<int> gOrderTmpConstraintPool = new FastList<int>(numConstraintPool);
			FastList<int> gOrderFrictionConstraintPool = new FastList<int>(numFrictionPool);
			{
		...
		public virtual float SolveGroup(FastList<CollisionObject> bodies, FastList<PersistentManifold> manifolds, int numManifolds, FastList<TypedConstraint> constraints, ContactSolverInfo infoGlobal, IDebugDraw debugDrawer)
		{
