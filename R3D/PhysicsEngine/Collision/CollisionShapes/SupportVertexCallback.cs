...
namespace R3D.PhysicsEngine
{
	...
	internal class SupportVertexCallback : ITriangleCallback
	{
		...
		public Vector3 SupportVectorLocal 
        {
            get { return _supportVecLocal; }
            set { _supportVecLocal = value; }
        }

		public Vector3 SupportVertexLocal 
        {
            get { return _supportVertexLocal; }
        }
		public Vector3 SupportVertexWorldSpace
        {
            get { return MathHelper.MatrixToVector(_worldTransform, _supportVertexLocal); }
        }
