...
namespace FMOD
{
    ...
    */
    public struct DSP_DESCRIPTION
    {
        ...
        public DSP_SETPOSITIONCALLBACK     setposition;        /* [in] Setposition callback.  This is called if the unit wants to update its position info but not process sounds.  Can be null. */
        ...
        public IntPtr                      userdata;           /* [in] Optional. Specify 0 to ignore. This is user sounds to be attached to the DSP unit during creation.  Access via DSP::getUserData. */
    }
    ...
    */
    public struct DSP_STATE
    {
        ...
        public IntPtr   plugindata;    /* [in] Plugin writer created sounds the output author wants to attach to this object. */
    };
    ...
    */
    ...
    [  
        ...
        <br>
        Because FMOD is a realtime audio processor, it doesn't have the luxury of knowing the peak for the whole sound (ie it can't see into the future), so it has to process sounds as it comes in.<br>
        To avoid very sudden changes in volume level based on small samples of new sounds, fmod fades towards the desired amplification which makes for smooth gain control.  The fadetime parameter can control this.<br>
