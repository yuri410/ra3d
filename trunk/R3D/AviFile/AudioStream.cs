...
namespace AviFile
{
	public class AudioStream : AviStream{
		...
		/// <summary>Returns all sounds needed to copy the stream</summary>
		/// <remarks>Do not forget to call Marshal.FreeHGlobal and release the raw sounds pointer</remarks>
		...
		/// <returns>Pointer to the wave sounds</returns>
